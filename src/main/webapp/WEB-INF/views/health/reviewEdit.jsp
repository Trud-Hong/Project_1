...
<body>
	...
	<div class="container">
		<div class="card">
			<h3>후기 수정하기</h3>
			<form action="<%=cp%>/reviewEdit_ok" method="post">
				...
				<div class="form-submit">
					...
					<button type="button" class="btnfoot" 
					    onclick="location.href='/heal/reviewArticle.do?review_id=${dto.review_id}&pageNum=${pageNum}&searchKey=${searchKey}&searchValue=${searchValue}'">
					    뒤로가기
					</button>
				</div>
